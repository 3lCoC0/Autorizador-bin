...
public interface CommercePlanJpaRepository extends JpaRepository<CommercePlanEntity, Long>, JpaSpecificationExecutor<CommercePlanEntity> {

    boolean existsByPlanCode(String planCode);

    Optional<CommercePlanEntity> findByPlanCode(String planCode);
}
